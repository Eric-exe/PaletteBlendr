...
class TestHSV(ut.TestCase):
    ...
    def test_one_step(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 0, 255)
        actual = interpolate_hsv_steps(color_start, color_end, 1)
        expected = [(0, 255, 0)]
    ...
    def test_two_steps(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 255, 0)
        actual = interpolate_hsv_steps(color_start, color_end, 2)
    ...
    def test_three_steps(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 0, 255)
        actual = interpolate_hsv_steps(color_start, color_end, 3)
    ...
    def test_four_steps(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 0, 255)
        actual = interpolate_hsv_steps(color_start, color_end, 4)
