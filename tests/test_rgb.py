...
from src.color_lerp.rgb import interpolate_rgb_steps
...
class TestRGB(ut.TestCase):
    ...
    def test_one_step(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 255, 0)
        actual = interpolate_rgb_steps(color_start, color_end, 1)
        expected = [(127, 127, 0)]
    ...
    def test_two_steps(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 255, 0)
        actual = interpolate_rgb_steps(color_start, color_end, 2)
    ...
    def test_three_steps(self):
        ...
        color_start = (255, 0, 0)
        color_end = (0, 255, 0)
        actual = interpolate_rgb_steps(color_start, color_end, 3)
    ...
    def test_four_steps(self):
        ...
        color_end = (0, 255, 127)
        actual = interpolate_rgb_steps(color_start, color_end, 4)
        expected = [(255, 127, 63), (170, 169, 84), (85, 212, 105), (0, 255, 127)]
        assert actual == expected, f"Expected: {0}\nActual: {1}".format(expected, actual)
